...
<head>
    ...
    <!-- Sobre Nós -->
     <main class="sobre-nos">
        <section class="banner-simples">
            <h1>Nossa História</h1>
        </section>

        <section class="conteudo-texto">
            <div class="texto">
                <p>A La Forno surgiu da missão de espalhar a todos a verdadeira pizza artesanal!</p>
            </div>
            <div class="imagem-loja">
                <img src="assets/laforno_fachada.png" alt="Fachada da Pizzaria La Forno">
            </div>
        </section>
     </main>
